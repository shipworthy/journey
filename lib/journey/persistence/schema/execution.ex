defmodule Journey.Persistence.Schema.Execution do
  ...
  schema "executions" do
    ...
    has_many(:values, Journey.Persistence.Schema.Execution.Value, preload_order: [desc: :ex_revision, asc: :node_name])

    has_many(:computations, Journey.Persistence.Schema.Execution.Computation,
      preload_order: [desc: :ex_revision_at_completion, asc: :node_name]
    )

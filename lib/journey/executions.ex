defmodule Journey.Executions do
  ...
  def create_new(graph_name, graph_version, nodes) do
    {:ok, execution} =
      Journey.Repo.transaction(fn repo ->
        ...
        _computations =
          nodes
          |> Enum.filter(fn %{type: type} -> type in Journey.Schema.Execution.ComputationType.values() end)
  ...
  def computation_db_to_atoms(computation) when is_struct(computation, Journey.Schema.Execution.Computation) do
    computation

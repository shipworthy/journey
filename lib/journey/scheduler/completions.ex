defmodule Journey.Scheduler.Completions do
  ...
  def mark_computation_as_completed(computation, inputs_to_capture, {:ok, result}) do
  ...
  def mark_computation_as_completed(computation, _inputs_to_capture, {:error, error_details}) do
